...
Spear流控参数Json格式，字段意义和范围。
{
    ...
    "video":{ 视频参数 (所有参数必填)
        "codec_prof":5, 视频编码协议 (-1自适应, 5[h264])
...
/// Spear引擎参数设置方式。
enum SpearEngineCtrlType {
    SPEAR_ENGINE_CTRL_TYPE_CLOUD  = 1, ///< 云配置方式。
    SPEAR_ENGINE_CTRL_TYPE_CUSTOM = 2, ///< 自定义方式。
};
...
class AV_EXPORT AVCloudSpearEngineCtrl {
protected:
    virtual ~AVCloudSpearEngineCtrl() {}
...
protected:
    virtual ~AVCustomSpearEngineCtrl() {}
